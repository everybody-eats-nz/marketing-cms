...
async function fetchEvent(slug: string) {
  ...
  // published version, so draft events 404 publicly and match the sitemap. This
  // mirrors page-body.tsx and is ready for `livePreview` on the events collection.
